...
TerminusElement = __webpack_require__(4);
TerminusElement = __webpack_require__(5);
...
function loadDirectory(directory){
    var files = {}
    if(__webpack_require__.m[/*require.resolve*/(__webpack_require__(0).resolve(directory+"/_manifest.js"))]) {
      var _dir = __webpack_require__(0)(directory+"/_manifest.js");
        for(name in _dir){
            var file = _dir[name];
            if(file.use){
                files[name] = !(function webpackMissingModule() { var e = new Error("Cannot find module \".\""); e.code = 'MODULE_NOT_FOUND';; throw e; }());
            }
        }           
    }     
    return files;
