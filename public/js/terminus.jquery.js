...
const Prism = __webpack_require__(1);
...
accordian = function(selector, options) {
  ...
  /* ************************
  	...
  	************************
   */
  var _click_on_type, _generateIcon, _initializeAccordian, _initializeAccordianContent, _initializeAccordianLink, _initializeInstance, _isValidQuery, _isValidString, _onAccordianLinkClick, defaults, instance;
  instance = "";
  defaults = {
    selector: '.accordian',
  ...
  _initializeAccordian = function($accordian) {
    _initializeAccordianLink($accordian);
    _initializeAccordianContent($accordian);
  };
  _initializeAccordianLink = function($accordian) {
    ...
    getLinkBasedSource = function($element) {
      ...
      if (_isValidQuery($dataLink)) {
        return $dataLink;
      } else if (_isValidQuery($classLink)) {
        return $classLink;
      } else if (_isValidQuery($anchorLink)) {
        return $anchorLink;
      } else {
        return getIconBasedSource($element);
      }
    ...
    getIconBasedSource = function($element) {
      ...
      if (_isValidQuery($classLink)) {
        $icon = getIconLink();
        if (!_isValidQuery($icon)) {
          $icon = _generateIcon;
          if (_isValidQuery($anchorLink)) {
  ...
  _initializeAccordianContent = function($accordian) {
    var $content;
    $content = $accordian.children(options.selector_content);
  };
  _isValidQuery = function(query) {
  ...
  this.onCreate = function() {
    ...
    return $accordians.each(function(i, accordian) {
      return _initializeAccordian($(this));
    });
  };
  this.open = (function() {
...
function initialize(config){
	...
	var scripts = __webpack_require__(3);
...
function initializeComponents(){
	var files = {}
	files["accordian"] = __webpack_require__(5);
	files["panel"] = __webpack_require__(4);
	return files;
}
